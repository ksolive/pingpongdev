...
static const oe_ecall_info_t _er_ecall_info_table[] = 
{
    { "enclave_helloworld" },
    { "er_testin" },
    { "er_readBatch" },
...
oe_result_t er_enclave_helloworld(oe_enclave_t* enclave)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_enclave_helloworld].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(er_enclave_helloworld, enclave_helloworld);

oe_result_t er_er_testin(
    ...
    size_t buffer_size)
{
    ...
    /* Marshalling struct. */
    er_testin_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(er_testin_args_t));
    if (buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.buffer_size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(er_testin_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (er_testin_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (buffer)
        OE_WRITE_IN_PARAM(buffer, 1, _args.buffer_size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_er_testin].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (er_testin_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(er_er_testin, er_testin);

oe_result_t er_er_readBatch(
    oe_enclave_t* enclave,
    uint8_t* dataBatch,
    size_t dataBatchSize)
{
    ...
    /* Marshalling struct. */
    er_readBatch_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.dataBatch = (uint8_t*)dataBatch;
    _args.dataBatchSize = dataBatchSize;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(er_readBatch_args_t));
    if (dataBatch)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.dataBatchSize);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(er_readBatch_args_t));
    if (dataBatch)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, _args.dataBatchSize);
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (er_readBatch_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (dataBatch)
        OE_WRITE_IN_OUT_PARAM(dataBatch, 1, _args.dataBatchSize, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_er_readBatch].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (er_readBatch_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    OE_READ_IN_OUT_PARAM(dataBatch, 1, _args.dataBatchSize);
...
OE_WEAK_ALIAS(er_er_readBatch, er_readBatch);

oe_result_t er_er_writeBatch(
    oe_enclave_t* enclave,
    size_t* _retval,
    uint8_t* dataBatch,
    size_t dataBatchSize)
{
    ...
    /* Marshalling struct. */
    er_writeBatch_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(er_writeBatch_args_t));
    if (dataBatch)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.dataBatchSize);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(er_writeBatch_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (er_writeBatch_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (dataBatch)
        OE_WRITE_IN_PARAM(dataBatch, 1, _args.dataBatchSize, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_er_writeBatch].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (er_writeBatch_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(er_er_writeBatch, er_writeBatch);

oe_result_t er_er_exchangeOht(
    oe_enclave_t* enclave,
    size_t indexFrom,
    size_t indexTo,
    uint8_t* bigOhtHead,
    size_t bigOhtHeadSize)
{
    ...
    /* Marshalling struct. */
    er_exchangeOht_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.indexFrom = indexFrom;
    _args.indexTo = indexTo;
    _args.bigOhtHead = (uint8_t*)bigOhtHead;
    _args.bigOhtHeadSize = bigOhtHeadSize;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(er_exchangeOht_args_t));
    if (bigOhtHead)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.bigOhtHeadSize);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(er_exchangeOht_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (er_exchangeOht_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (bigOhtHead)
        OE_WRITE_IN_PARAM(bigOhtHead, 1, _args.bigOhtHeadSize, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_er_exchangeOht].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (er_exchangeOht_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(er_er_exchangeOht, er_exchangeOht);

oe_result_t er_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(er_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t er_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(er_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t er_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(er_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t er_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(er_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t er_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _er_ecall_info_table[er_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(er_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static void ocall_host_testOcall(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_testOcall_args_t* _pargs_in = (host_testOcall_args_t*)input_buffer;
    host_testOcall_args_t* _pargs_out = (host_testOcall_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->buffer)
        OE_SET_IN_POINTER(buffer, 1, _pargs_in->bufferSize, uint8_t*);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_swapIn_args_t* _pargs_in = (host_swapIn_args_t*)input_buffer;
    host_swapIn_args_t* _pargs_out = (host_swapIn_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->inDataBuffer)
        OE_SET_IN_POINTER(inDataBuffer, 1, _pargs_in->DataBufferSize, uint8_t*);
    ...
    /* Call user function. */
    host_swapIn(
        _pargs_in->bigOhtIndex,
        _pargs_in->inDataBuffer,
        _pargs_in->DataBufferSize);
...
static oe_ocall_func_t _er_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_host_helloworld,
    (oe_ocall_func_t) ocall_host_testOcall,
    (oe_ocall_func_t) ocall_host_swapIn,
...
oe_result_t oe_create_er_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _er_ocall_function_table,
               90,
               _er_ecall_info_table,
                10,
               enclave);
}
