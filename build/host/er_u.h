 ...
 */
#ifndef EDGER8R_ER_U_H
#define EDGER8R_ER_U_H
...
oe_result_t er_testin(
    oe_enclave_t* enclave,
    uint8_t* buffer,
    size_t buffer_size);

oe_result_t er_readBatch(
    oe_enclave_t* enclave,
    uint8_t* dataBatch,
    size_t dataBatchSize);

oe_result_t er_writeBatch(
    oe_enclave_t* enclave,
    size_t* _retval,
    uint8_t* dataBatch,
    size_t dataBatchSize);

oe_result_t er_exchangeOht(
    oe_enclave_t* enclave,
    size_t indexFrom,
    size_t indexTo,
    uint8_t* bigOhtHead,
