...
enum
{
    er_fcn_id_enclave_helloworld = 0,
    er_fcn_id_er_testin = 1,
    er_fcn_id_er_readBatch = 2,
    er_fcn_id_er_writeBatch = 3,
    er_fcn_id_er_exchangeOht = 4,
    er_fcn_id_oe_get_sgx_report_ecall = 5,
    er_fcn_id_oe_get_report_v2_ecall = 6,
    er_fcn_id_oe_verify_local_report_ecall = 7,
    er_fcn_id_oe_sgx_init_context_switchless_ecall = 8,
    er_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 9,
    er_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};
...
typedef struct _er_testin_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _er_readBatch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    uint8_t* dataBatch;
    size_t dataBatchSize;
} er_readBatch_args_t;

typedef struct _er_writeBatch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    uint8_t* dataBatch;
    size_t dataBatchSize;
} er_writeBatch_args_t;

typedef struct _er_exchangeOht_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t indexTo;
    uint8_t* bigOhtHead;
    size_t bigOhtHeadSize;
} er_exchangeOht_args_t;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    er_testin_args_t* _pargs_in = (er_testin_args_t*)input_buffer;
    er_testin_args_t* _pargs_out = (er_testin_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->buffer)
        OE_SET_IN_POINTER(buffer, 1, _pargs_in->buffer_size, uint8_t*);
...
static void ecall_er_readBatch(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    er_readBatch_args_t* _pargs_in = (er_readBatch_args_t*)input_buffer;
    er_readBatch_args_t* _pargs_out = (er_readBatch_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->dataBatch)
        OE_SET_IN_OUT_POINTER(dataBatch, 1, _pargs_in->dataBatchSize, uint8_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->dataBatch)
        OE_COPY_AND_SET_IN_OUT_POINTER(dataBatch, 1, _pargs_in->dataBatchSize, uint8_t*);
...
static void ecall_er_writeBatch(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    er_writeBatch_args_t* _pargs_in = (er_writeBatch_args_t*)input_buffer;
    er_writeBatch_args_t* _pargs_out = (er_writeBatch_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->dataBatch)
        OE_SET_IN_POINTER(dataBatch, 1, _pargs_in->dataBatchSize, uint8_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = er_writeBatch(
        _pargs_in->dataBatch,
        _pargs_in->dataBatchSize);
...
static void ecall_er_exchangeOht(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    er_exchangeOht_args_t* _pargs_in = (er_exchangeOht_args_t*)input_buffer;
    er_exchangeOht_args_t* _pargs_out = (er_exchangeOht_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->bigOhtHead)
        OE_SET_IN_POINTER(bigOhtHead, 1, _pargs_in->bigOhtHeadSize, uint8_t*);
    ...
    er_exchangeOht(
        _pargs_in->indexFrom,
        _pargs_in->indexTo,
        _pargs_in->bigOhtHead,
        _pargs_in->bigOhtHeadSize);
...
oe_ecall_func_t oe_ecalls_table[] = {
    ...
    (oe_ecall_func_t) ecall_er_testin,
    (oe_ecall_func_t) ecall_er_readBatch,
    (oe_ecall_func_t) ecall_er_writeBatch,
    (oe_ecall_func_t) ecall_er_exchangeOht,
...
enum
{
    er_fcn_id_host_helloworld = 0,
    er_fcn_id_host_testOcall = 1,
    er_fcn_id_host_swapIn = 2,
    er_fcn_id_oe_syscall_epoll_create1_ocall = 3,
    er_fcn_id_oe_syscall_epoll_wait_ocall = 4,
    er_fcn_id_oe_syscall_epoll_wake_ocall = 5,
    er_fcn_id_oe_syscall_epoll_ctl_ocall = 6,
    er_fcn_id_oe_syscall_epoll_close_ocall = 7,
    er_fcn_id_oe_syscall_open_ocall = 8,
    er_fcn_id_oe_syscall_read_ocall = 9,
    er_fcn_id_oe_syscall_write_ocall = 10,
    er_fcn_id_oe_syscall_readv_ocall = 11,
    er_fcn_id_oe_syscall_writev_ocall = 12,
    er_fcn_id_oe_syscall_lseek_ocall = 13,
    er_fcn_id_oe_syscall_pread_ocall = 14,
    er_fcn_id_oe_syscall_pwrite_ocall = 15,
    er_fcn_id_oe_syscall_close_ocall = 16,
    er_fcn_id_oe_syscall_flock_ocall = 17,
    er_fcn_id_oe_syscall_fsync_ocall = 18,
    er_fcn_id_oe_syscall_fdatasync_ocall = 19,
    er_fcn_id_oe_syscall_dup_ocall = 20,
    er_fcn_id_oe_syscall_opendir_ocall = 21,
    er_fcn_id_oe_syscall_readdir_ocall = 22,
    er_fcn_id_oe_syscall_rewinddir_ocall = 23,
    er_fcn_id_oe_syscall_closedir_ocall = 24,
    er_fcn_id_oe_syscall_stat_ocall = 25,
    er_fcn_id_oe_syscall_fstat_ocall = 26,
    er_fcn_id_oe_syscall_access_ocall = 27,
    er_fcn_id_oe_syscall_link_ocall = 28,
    er_fcn_id_oe_syscall_unlink_ocall = 29,
    er_fcn_id_oe_syscall_rename_ocall = 30,
    er_fcn_id_oe_syscall_truncate_ocall = 31,
    er_fcn_id_oe_syscall_ftruncate_ocall = 32,
    er_fcn_id_oe_syscall_mkdir_ocall = 33,
    er_fcn_id_oe_syscall_rmdir_ocall = 34,
    er_fcn_id_oe_syscall_fcntl_ocall = 35,
    er_fcn_id_oe_syscall_ioctl_ocall = 36,
    er_fcn_id_oe_syscall_poll_ocall = 37,
    er_fcn_id_oe_syscall_kill_ocall = 38,
    er_fcn_id_oe_syscall_close_socket_ocall = 39,
    er_fcn_id_oe_syscall_socket_ocall = 40,
    er_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 41,
    er_fcn_id_oe_syscall_socketpair_ocall = 42,
    er_fcn_id_oe_syscall_connect_ocall = 43,
    er_fcn_id_oe_syscall_accept_ocall = 44,
    er_fcn_id_oe_syscall_bind_ocall = 45,
    er_fcn_id_oe_syscall_listen_ocall = 46,
    er_fcn_id_oe_syscall_recvmsg_ocall = 47,
    er_fcn_id_oe_syscall_sendmsg_ocall = 48,
    er_fcn_id_oe_syscall_recv_ocall = 49,
    er_fcn_id_oe_syscall_recvfrom_ocall = 50,
    er_fcn_id_oe_syscall_send_ocall = 51,
    er_fcn_id_oe_syscall_sendto_ocall = 52,
    er_fcn_id_oe_syscall_recvv_ocall = 53,
    er_fcn_id_oe_syscall_sendv_ocall = 54,
    er_fcn_id_oe_syscall_shutdown_ocall = 55,
    er_fcn_id_oe_syscall_setsockopt_ocall = 56,
    er_fcn_id_oe_syscall_getsockopt_ocall = 57,
    er_fcn_id_oe_syscall_getsockname_ocall = 58,
    er_fcn_id_oe_syscall_getpeername_ocall = 59,
    er_fcn_id_oe_syscall_getaddrinfo_open_ocall = 60,
    er_fcn_id_oe_syscall_getaddrinfo_read_ocall = 61,
    er_fcn_id_oe_syscall_getaddrinfo_close_ocall = 62,
    er_fcn_id_oe_syscall_getnameinfo_ocall = 63,
    er_fcn_id_oe_syscall_nanosleep_ocall = 64,
    er_fcn_id_oe_syscall_clock_nanosleep_ocall = 65,
    er_fcn_id_oe_syscall_getpid_ocall = 66,
    er_fcn_id_oe_syscall_getppid_ocall = 67,
    er_fcn_id_oe_syscall_getpgrp_ocall = 68,
    er_fcn_id_oe_syscall_getuid_ocall = 69,
    er_fcn_id_oe_syscall_geteuid_ocall = 70,
    er_fcn_id_oe_syscall_getgid_ocall = 71,
    er_fcn_id_oe_syscall_getegid_ocall = 72,
    er_fcn_id_oe_syscall_getpgid_ocall = 73,
    er_fcn_id_oe_syscall_getgroups_ocall = 74,
    er_fcn_id_oe_syscall_uname_ocall = 75,
    er_fcn_id_oe_get_supported_attester_format_ids_ocall = 76,
    er_fcn_id_oe_get_qetarget_info_ocall = 77,
    er_fcn_id_oe_get_quote_ocall = 78,
    er_fcn_id_oe_get_quote_verification_collateral_ocall = 79,
    er_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 80,
    er_fcn_id_oe_verify_quote_ocall = 81,
    er_fcn_id_oe_sgx_get_cpuid_table_ocall = 82,
    er_fcn_id_oe_sgx_backtrace_symbols_ocall = 83,
    er_fcn_id_oe_sgx_log_backtrace_ocall = 84,
    er_fcn_id_oe_sgx_thread_wake_wait_ocall = 85,
    er_fcn_id_oe_sgx_wake_switchless_worker_ocall = 86,
    er_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 87,
    er_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 88,
    er_fcn_id_oe_verify_tdx_quote_ocall = 89,
    er_fcn_id_untrusted_call_max = OE_ENUM_MAX
};
...
typedef struct _host_testOcall_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    uint8_t* buffer;
    size_t bufferSize;
} host_testOcall_args_t;

typedef struct _host_swapIn_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t bufferSize)
{
    ...
    /* Marshalling struct. */
    host_testOcall_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.buffer = (uint8_t*)buffer;
    _args.bufferSize = bufferSize;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(host_testOcall_args_t));
    if (buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.bufferSize);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(host_testOcall_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (host_testOcall_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (buffer)
        OE_WRITE_IN_PARAM_WITH_BARRIER(buffer, 1, _args.bufferSize, uint8_t*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (host_testOcall_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t DataBufferSize)
{
    ...
    /* Marshalling struct. */
    host_swapIn_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.bigOhtIndex = bigOhtIndex;
    _args.inDataBuffer = (uint8_t*)inDataBuffer;
    _args.DataBufferSize = DataBufferSize;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(host_swapIn_args_t));
    if (inDataBuffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.DataBufferSize);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(host_swapIn_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (host_swapIn_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (inDataBuffer)
        OE_WRITE_IN_PARAM_WITH_BARRIER(inDataBuffer, 1, _args.DataBufferSize, uint8_t*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (host_swapIn_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_epoll_create1_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_epoll_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_epoll_wake_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_epoll_wake_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_epoll_event* event)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_epoll_ctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t epfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_epoll_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_write_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_readv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_writev_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int whence)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_lseek_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_pread_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_pwrite_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int operation)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_flock_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_fsync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_fdatasync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t oldfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_dup_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* name)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_opendir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_dirent* entry)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_readdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_rewinddir_ocall(uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_rewinddir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_closedir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_stat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_fstat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_access_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_link_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_unlink_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_rename_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_truncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_ftruncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_mkdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_rmdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_fcntl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_ioctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_poll_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int signum)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_kill_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_close_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int protocol)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_shutdown_sockets_device_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sv[2])
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_socketpair_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_connect_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_accept_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_bind_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int backlog)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_listen_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_recvmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_sendmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_recv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_recvfrom_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_send_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_sendto_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_recvv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_sendv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int how)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_shutdown_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t optlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_setsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* optlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getsockname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getpeername_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t* handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getaddrinfo_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    char* ai_canonname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getaddrinfo_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getaddrinfo_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getnameinfo_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_clock_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getpid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getppid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getppid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpgrp_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getpgrp_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_geteuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_geteuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getgid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getegid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getegid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int pid)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getpgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    unsigned int* list)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_getgroups_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_utsname* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_syscall_uname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    format_ids_t* format_ids)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_get_supported_attester_format_ids_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_target_info_t* target_info)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_get_qetarget_info_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_get_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_verify_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t cpuid_table_buffer_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_sgx_get_cpuid_table_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* symbols_buffer_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_sgx_backtrace_symbols_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_sgx_log_backtrace_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t self_tcs)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_sgx_thread_wake_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_wake_switchless_worker_ocall(oe_host_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_sgx_wake_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_sleep_switchless_worker_ocall(oe_enclave_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_sgx_sleep_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    tdx_quote_collateral_t* collateral)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_get_tdx_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t* p_supplemental_data_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             er_fcn_id_oe_verify_tdx_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
